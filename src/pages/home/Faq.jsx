  ...
  return (
    <div>
      <div className="text-center space-y-5">
         <h2 className="text-4xl text-[#067A87] font-semibold"> Frequently Asked Question (FAQ)  </h2>
        <p className="w-9/12  mx-auto">Enhance posture, mobility, and well-being effortlessly with Posture Pro. Achieve proper alignment, reduce pain, and strengthen your body with ease!</p>
      </div>
      ...
      <div className="text-center my-5">
         <MyBtn1 className={'bg-primary'}>See More FAQ's</MyBtn1>
      </div>
    </div>
  )
}
